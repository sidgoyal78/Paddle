...
def convolution_net(data, label, input_dim, class_dim=2, emb_dim=1024,
    ...
    avg_cost = fluid.layers.mean(cost, dtype = 'float64')
...
def train(word_dict,
    ...
    adam = fluid.optimizer.SGD(learning_rate=0.0005) #Learning rate of 5e-4 works for conv models and 2e-3 for LSTM model
